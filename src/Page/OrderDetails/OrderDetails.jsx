            ...
            <div className="md:text-base text-sm flex-1  font-semibold   md:border-r-2 md:border-black md:pr-10">
              ...
              <div className="space-y-1 w-full">
                <div className="flex items-center justify-between">
                  <p>Full Name :</p>
                  <p className="text-start">{formData.name}</p>
                </div>
                <div className="flex items-center justify-between">
                  <p>Country :</p>
                  <p>Bangladesh</p>
                ...
                <div className="flex items-center justify-between">
                  <p>Address :</p>
                  <p>{formData.permanent_address}</p>
                </div>
                <div className="flex items-center justify-between">
                  <p>Order Notes :</p>
                ...
                <tr>
                  <td className="border text-center w-10 h-12 px-2">
                    <img
                      ...
                      src={data.coursePurchaseData.photo}
                      alt=""
                    />
                  </td>
                  <td className="lg:py-6 md:py-4 py-2 text-center border">
                    {data.coursePurchaseData.name}
                  </td>
                  <td className="lg:py-6 md:py-4 py-2 text-center border">
                    {data.coursePurchaseData.name}
                  </td>
